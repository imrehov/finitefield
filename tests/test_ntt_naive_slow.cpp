...
TEST_CASE("naive NTT works for size 4 modulo 17 vec") {
    ...
    auto result = ntt_naive_slow<4, 17>(a);
...
TEST_CASE("naive NTT of constant polynomial gives same value everywhere vec") {
    std::vector<mod_t<17>> a{
        mod_t<17>{3},
        mod_t<17>{0},
        mod_t<17>{0},
...
TEST_CASE("naive NTT of x gives powers of root of unity vec") {
    std::vector<mod_t<17>> a{
        mod_t<17>{0},
        mod_t<17>{1},
        mod_t<17>{0},
...
TEST_CASE("naive NTT of all ones collapses to first coefficient vec") {
    std::vector<mod_t<17>> a{
        mod_t<17>{1},
        mod_t<17>{1},
        mod_t<17>{1},
